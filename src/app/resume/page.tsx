      ...
      <div className={S.resumeContainer}>
        ...
        <section className={S.contactInfo}>
          <div>
            <div className={S.contactItem}>
              <span>이메일: </span>
              <a href="mailto:example@mail.com" className="ml-1 text-primary-600 hover:underline">example@mail.com</a>
            </div>
            <div className={S.contactItem}>
              <span>연락처: </span>
              <span className="ml-1">010-1234-5678</span>
            </div>
          </div>
          <div>
            <div className={S.contactItem}>
              <span>GitHub: </span>
              <a href="https://github.com/username" target="_blank" rel="noopener noreferrer" className="ml-1 text-primary-600 hover:underline">github.com/username</a>
            </div>
            <div className={S.contactItem}>
              <span>블로그: </span>
              <a href="https://blog.example.com" target="_blank" rel="noopener noreferrer" className="ml-1 text-primary-600 hover:underline">blog.example.com</a>
            </div>
          </div>
        </section>
        ...
        <section className={S.section}>
          ...
          <p className="text-gray-600 dark:text-gray-300">
            5년 이상의 프론트엔드 개발 경험을 가진 개발자로, 사용자 중심의 인터페이스 설계와 
            성능 최적화에 역량을 갖추고 있습니다. React와 Next.js 기반의 웹 애플리케이션 개발에 
            전문성을 보유하고 있으며, 새로운 기술 학습과 팀 협업에 열정을 가지고 있습니다.
          </p>
        </section>
        ...
        <section className={S.section}>
          ...
          <div className={S.experienceItem}>
            <div className={S.experienceHeader}>
              <div>
                <span className={S.experienceTitle}>시니어 프론트엔드 개발자</span>
                <span> @ </span>
            ...
            <ul className={S.experienceDesc + " list-disc list-inside"}>
              ...
              <li>TypeScript, Next.js, React Query를 활용한 견고한 코드베이스 구축</li>
        ...
        <section className={S.section}>
          ...
          <div className={S.resumeGrid}>
            <div>
              <h3 className="font-medium mb-2 text-gray-700 dark:text-gray-200">프론트엔드</h3>
            ...
            <div>
              <h3 className="font-medium mb-2 text-gray-700 dark:text-gray-200">상태 관리 & API</h3>
              <div className={S.skillsList}>
            ...
            <div>
              <h3 className="font-medium mb-2 text-gray-700 dark:text-gray-200">테스트 & 도구</h3>
              <div className={S.skillsList}>
            ...
            <div>
              <h3 className="font-medium mb-2 text-gray-700 dark:text-gray-200">기타</h3>
              <div className={S.skillsList}>
